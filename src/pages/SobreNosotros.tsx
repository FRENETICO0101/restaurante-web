...
export default function SobreNosotros() {
  return (
    <main>
      <SectionContainer>
        <SEO title="Sobre Nosotros" description="Conoce nuestra historia y filosofía culinaria." />
        ...
        <div className="prose max-w-none prose-neutral">
          ...
          <p className="text-sm text-neutral-500">Reemplazar este texto una vez se recopile la información real.</p>
        </div>
      </SectionContainer>
    </main>
  )
