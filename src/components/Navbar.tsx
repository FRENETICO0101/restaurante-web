    ...
    <header className="sticky top-0 z-40 w-full border-b border-neutral-200 bg-white/80 backdrop-blur">
      <div className="container-section flex h-16 items-center justify-between">
        ...
        <div className="hidden items-center gap-4 md:flex">
          <a href="tel:+520000000000" className="text-neutral-600 hover:text-amber-600" aria-label="Llamar">
          ...
          <a href="https://wa.me/520000000000" target="_blank" rel="noreferrer" className="text-neutral-600 hover:text-emerald-600" aria-label="WhatsApp">
